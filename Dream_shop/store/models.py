...
class Product(models.Model):
    ...
    price = models.IntegerField()                                                        # Prix du produit (champ entier)
    images = models.ImageField(upload_to='photos/products')                              # Images du produit (champ pour télécharger une image, stockée dans le répertoire 'photos/products')
    ...
    stock = models.IntegerField()                                                        # Stock disponible du produit (champ entier)
